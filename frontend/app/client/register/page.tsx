...
import { Lock, Mail, User, Coffee, ArrowLeft, ShoppingCartIcon } from "lucide-react"
...
function ClientRegisterForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (success) {
      if (hasPendingCart) {
        addNotification("Compte créé avec succès! Vous pouvez maintenant finaliser votre commande", "success")
      }
      router.push("/menu")
    }
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-teal-50 to-emerald-100 p-4">
      <Card className="w-full max-w-md p-8 shadow-xl">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Inscription Client</h1>
        ...
        <div className="mt-6 pt-6 border-t border-gray-200">
          <p className="text-center text-sm text-gray-600">
            ...
            <Link href="/client/login" className="text-emerald-600 hover:text-emerald-700 font-medium">
              Se connecter
            </Link>
          </p>
        </div>
