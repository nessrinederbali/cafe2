...
export function Sidebar({ currentView, onViewChange, isOpen, onClose, isAdmin }: SidebarProps) {
  const navItems = [
    { id: "dashboard" as const, label: "Tableau de Bord",   icon: LayoutDashboardIcon, adminOnly: false },
    { id: "articles"  as const, label: "Produits",          icon: PackageIcon,          adminOnly: false },
    { id: "categories"as const, label: "Catégories",        icon: TagIcon,              adminOnly: true  },
    { id: "suppliers" as const, label: "Fournisseurs",      icon: TruckIcon,            adminOnly: true  },
    { id: "menu"      as const, label: "Menu Client",       icon: MenuIcon,             adminOnly: true  },
